...
public class VoetbalServiceImpl implements VoetbalService{
    ...
    public VoetbalServiceImpl() {
        ...
        mapWedstrijdById.put("4", new WedstrijdTicket(new Wedstrijd("4", new String[]{"Spanje", "Duitsland"}, 28, 11, 18), 95));
        mapWedstrijdById.put("5", new WedstrijdTicket(new Wedstrijd("5", new String[]{"Frankrijk", "Denemarken"}, 30, 11, 15), 45));
        mapWedstrijdById.put("6", new WedstrijdTicket(new Wedstrijd("6", new String[]{"Argentinië", "Mexico"}, 30, 11, 18), 10));
